...
DataPreparator.prototype.create = function(data, dest) {
    ...
    // Store repo as JSON file on the file system
    fs.writeFileSync(dest, JSON.stringify(repo, null, '\t'));

    // Log some info
    console.log('Styleguide data written to ' + dest);
    console.log('\nInventory:');
    console.log('- Colors: ' + colors.length);
    console.log('- Color groups: ' + colorsByGroup.length);
    console.log('- Fonts: ' + fonts.length);
    console.log('- Font sizes: ' + fontSizes.length);
    console.log('- Line heights: ' + lineHeights.length);
    console.log('- Box shadows: ' + boxShadows.length);
    console.log('- Gradients: ' + gradients.length);
    console.log('- Spacings: ' + spacings.length);
    console.log('- Spacing groups: ' + spacingsByGroup.length);
    console.log('- Timings: ' + timings.length);
    console.log('- Transitions: ' + transitions.length);
};


module.exports = DataPreparator;
